...
- Landing page with a hero, GitHub stat tiles, a contribution calendar, and language statistics
...
`/` home page (hero, stat tiles, contribution calendar, language chart), `/about` about page, `/projects` catalogue,
...
says so ("by bytes of code, notebooks excluded").
