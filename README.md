...
- Landing page with a hero, live GitHub stat tiles (contributions, repositories) and static career numbers, a contribution calendar, language statistics (notebooks excluded, method printed under the chart), and project status counts
...
| Path              | Description                                                  |
| ----------------- | ------------------------------------------------------------ |
| `/`               | Home — hero, GitHub stat tiles, activity calendar, languages, project counts |
| `/about`          | About page                                                   |
